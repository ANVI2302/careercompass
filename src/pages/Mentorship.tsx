    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex gap-4 mb-8">
          <Button
            onClick={() => setTab("my")}
            className={`${tab === "my" ? "bg-blue-600" : "bg-slate-700"} hover:opacity-90`}
          >
            My Mentors
          </Button>
          <Button
            onClick={() => setTab("find")}
            className={`${tab === "find" ? "bg-blue-600" : "bg-slate-700"} hover:opacity-90`}
          >
            Find Mentors
          </Button>
        </div>
        ...
        {tab === "my" ? (
          mentors.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {mentors.map((m) => (
                <Card key={m.id} className="bg-slate-800 border-slate-700 p-6 hover:border-blue-500 transition-colors">
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-500 text-xs mt-2">Focus: <span className="text-blue-300">{m.skill_focus}</span></p>
                      <p className={`text-xs mt-2 px-2 py-1 rounded w-fit ${m.status === "active" ? "bg-green-900 text-green-200" :
                  ...
                  <button className="w-full mt-4 flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white py-2 rounded transition">
          ...
          <div>
            <div className="flex gap-4 mb-8">
              ...
              />
              <Button onClick={handleFindMentors} className="bg-blue-600 hover:bg-blue-700">
                Search
              </Button>
            </div>
            ...
            {availableMentors.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {availableMentors.map((mentor) => (
                  <Card key={mentor.id} className="bg-slate-800 border-slate-700 p-6 hover:border-blue-500 transition-colors">
                    {mentor.avatar_url && (
                    ...
                    <Button
                      ...
                      className="w-full mt-4 bg-blue-600 hover:bg-blue-700 flex items-center justify-center gap-2"
                    >
